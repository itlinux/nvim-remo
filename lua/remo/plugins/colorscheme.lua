local function enable_transparency()
    ...
    vim.api.nvim_set_hl(0, 'LineNrBelow', { fg = '#FFA500', bold = true })
end
...
return {
    ...
    -- NOTE : tokyonight
    {
        ...
        config = function()
            ...
            local border = "#547998"
            local color_line_nr       = "#FFA500" -- orange
            local color_cursor_line_nr = "#00FF88" -- mint green
            local color_line_nr_below= "#5d6d7e" -- gray
            local color_line_nr_above= "#fdd835" -- darker gray
            -- local set = vim.api.nvim_set_hl
            -- set(O, 'LineNr', { fg = color.bg, })
            -- remo local LineNrAbove = "#orange"
            ...
            require("tokyonight").setup({
               ...
               on_highlights = function(highlights, colors)
                highlights.LineNr        = { fg = color_line_nr, bg = colors.none }
                highlights.CursorLineNr  = { fg = color_cursor_line_nr, bold = true, bg = colors.none }
                highlights.LineNrAbove   = { fg = color_line_nr_above, bg = colors.none }
                highlights.LineNrBelow   = { fg = color_line_nr_below, bg = colors.none }
            end,
            })
